...
struct Predictor {
    ...
    bool link_executed { 0 };
    bool branch_taken_executed { 0 };
    sc_bv<32> branch_target_executed { 0 };
    ...
    void operator==(const std::unique_ptr<Vexecute>& dut) const {
        ...
        assert(rt_executed == dut->rt_executed.read());
        assert(rt_data_excuted == dut->rt_data_excuted.read());
        assert(link_executed == dut->link_executed.read());
        assert(branch_taken_executed == dut->branch_taken_executed.read());
        assert(branch_target_executed == dut->branch_target_executed.read());
...
const Predictor predictor[] {
    {
        ...
        .rt_data_excuted = 102,
        .link_executed = 0,
        .branch_taken_executed = 0,
        .branch_target_executed = 0,
        .load_executed = 0,
    ...
    },
    {
        ...
        .link_executed = 0,
        .branch_taken_executed = 0,
        .branch_target_executed = (384 + ( 1*4) + 4),
        .load_executed = 0,
        .load_sign_extend_executed = 0,
        .load_store_data_size_mode_executed = 0,
        .store_executed = 0,
    },
    {
        ...
        .link_executed = 0,
        .branch_taken_executed = 0,
        .branch_target_executed = (388 + (-3*4) + 4),
        .load_executed = 0,
        .load_sign_extend_executed = 0,
        .load_store_data_size_mode_executed = 0,
        .store_executed = 0,
    },
    {
        ...
        .link_executed = 0,
        .branch_taken_executed = 0,
        .branch_target_executed = (392 + ( 1*4) + 4),
        .load_executed = 0,
        .load_sign_extend_executed = 0,
        .load_store_data_size_mode_executed = 0,
        .store_executed = 0,
    },
    {
        ...
        .link_executed = 0,
        .branch_taken_executed = 0,
        .branch_target_executed = (396 + (-3*4) + 4),
        .load_executed = 0,
        .load_sign_extend_executed = 0,
        .load_store_data_size_mode_executed = 0,
        .store_executed = 0,
    },
    {
        ...
        .link_executed = 0,
        .branch_taken_executed = 0,
        .branch_target_executed = (400 + ( 5*4) + 4),
        .load_executed = 0,
        .load_sign_extend_executed = 0,
        .load_store_data_size_mode_executed = 0,
        .store_executed = 0,
    },
    {
        ...
        .link_executed = 0,
        .branch_taken_executed = 0,
        .branch_target_executed = (404 + (-7*4) + 4),
        .load_executed = 0,
        .load_sign_extend_executed = 0,
        .load_store_data_size_mode_executed = 0,
        .store_executed = 0,
    },
    {
        ...
        .link_executed = 0,
        .branch_taken_executed = 0,
        .branch_target_executed = (408 + ( 5*4) + 4),
        .load_executed = 0,
        .load_sign_extend_executed = 0,
        .load_store_data_size_mode_executed = 0,
        .store_executed = 0,
    },
    {
        ...
        .link_executed = 0,
        .branch_taken_executed = 0,
        .branch_target_executed = (412 + (-7*4) + 4),
        .load_executed = 0,
        .load_sign_extend_executed = 0,
        .load_store_data_size_mode_executed = 0,
        .store_executed = 0,
    },
    {
        ...
        .rt_data_excuted = 0,
        .link_executed = 0,
        .branch_taken_executed = 1,
        .branch_target_executed = (108 * 4),
        .load_executed = 0,
        .load_sign_extend_executed = 0,
        .load_store_data_size_mode_executed = 0,
        .store_executed = 0,
    ...
    // ------------------//------------------ //
    {
        ...
        .link_executed = 0,
        .branch_taken_executed = 1,
        .branch_target_executed = (484 + (-1 * 4) + 4),
        .load_executed = 0,
        .load_sign_extend_executed = 0,
        .load_store_data_size_mode_executed = 0,
        .store_executed = 0,
...
int sc_main(int argc, char* argv[]) {
    ...
    // outputs
    sc_signal<bool> branch_taken_executed;
    sc_signal<bool> rd_executed;
    sc_signal<bool> alu_mode_executed;
    sc_signal<bool> rt_executed;
    sc_signal<bool> link_executed;
    ...
    sc_signal<sc_bv<32>> branch_target_executed;
    ...
    // outputs
    dut->branch_taken_executed(branch_taken_executed);
    dut->rd_executed(rd_executed);
    dut->alu_mode_executed(alu_mode_executed);
    dut->rt_executed(rt_executed);
    dut->link_executed(link_executed);
    ...
    dut->branch_target_executed(branch_target_executed);
